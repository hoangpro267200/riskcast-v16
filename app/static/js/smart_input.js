/**
 * ============================================================
 * SMART INPUT SYSTEM - RISKCAST v13.0 ULTIMATE
 * ============================================================
 * 
 * MERGED VERSION combining best of v12.5 + v13.0:
 * ✅ Route → Transport → POL → POD → Auto-fill (v13.0)
 * ✅ Port Search with Suggestions (v12.5)
 * ✅ Container Recommendation (v12.5)
 * ✅ Transit Time Calculator (v12.5)
 * ✅ Real-time Validation (v12.5)
 * ✅ Progress Tracking (v12.5)
 * ✅ Slider Displays (v13.0)
 * ✅ Collapsible Sections (v13.0)
 * ✅ Smart Defaults (v12.5)
 * ✅ Copy Previous Shipment (v12.5)
 * ✅ Mobile Optimization (v12.5)
 * ✅ Enhanced Demo Mode (v12.5)
 * 
 * Compatible với custom dropdown system hiện có
 * ============================================================
 */
...
const SmartInputSystem = {
    ...
    populateTransportModes: function(routeKey) {
        const LOGISTICS_DATA = this.getLogisticsData();
        if (!LOGISTICS_DATA) {
    ...
    calculateTransitTime: function() {
        // Legacy function - now handled by initTransitTimeCalculation
